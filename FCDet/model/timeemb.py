...
class DurationEncoding(nn.Module):
    def __init__(self, dim, dataset):
        ...
        if dataset == 'fakett':
            ...
            with open('./features/fakett/fakett_segment_duration.json', 'r') as json_file:
...
class TimeClassification(nn.Module):
    def __init__(self, dataset):
        super(TimeClassification, self).__init__()
